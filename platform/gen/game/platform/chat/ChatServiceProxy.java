...
public final class ChatServiceProxy extends ProxyBase {
	public final class EnumCall{
		public static final int ChatService_uploadChat_List = 1;
	}
	...
	public Object getMethodFunction(Service service, int methodKey) {
		...
		switch (methodKey) {
			case EnumCall.ChatService_uploadChat_List: {
				return (GofFunction1<List>)serv::uploadChat;
			}
			default: break;
		}
		return null;
	 ...
	 * @return
	 */
	public static ChatServiceProxy newInstance(String node, String port, Object id) {
	...
	public void uploadChat(List chatList) {
		callerInfo = Utils.getCallerInfo();
		remote.callerInfo = callerInfo;
		localPort.call(immutableOnce, remote, EnumCall.ChatService_uploadChat_List, "ChatServiceProxy.uploadChat", new Object[] {chatList});
