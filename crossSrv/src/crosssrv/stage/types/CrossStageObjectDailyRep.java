...
public class CrossStageObjectDailyRep extends CrossStageObject {
	private HumanMirrorObject humanMirrorObj;// 挑战者
	private PassParam passParam;// 额外数据
	
	public CrossStageObjectDailyRep(HumanMirrorObject humanMirrorObj, CrossPort port, long stageId, int stageSn, int mapSn,
			int fightType) {
	...
	public CrossStageObjectDailyRep(FightRecord fightRecord, CrossPort port, long stageId, int stageSn, int mapSn) {
