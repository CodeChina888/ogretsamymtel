...
public class EventPlot extends StageEventBase {
	/** 场景ID **/
	int plot;
	/** 是否完成 **/
	...
	public void setFinish(FightStageObject stageObj,int select) {
		isFinish = true;
		stageObj.removeStageEvent(this);
		FightParamPlotFinish param = new FightParamPlotFinish(plot,select);
		stageObj.doStageOp(StageOpType.ActionPlotFinish, param);
	}
