...
public enum StageOpType{
	 ...
	 * @param value
	 */
	private StageOpType(long value) {
		this.value = value;
	}
	 ...
	 * @return
	 */
	public static StageOpType get(String name) {
		StageOpType type = null;
	 ...
	 * @return
	 */
	public static StageOpType getByValue(long value) {
		StageOpType type = null;
