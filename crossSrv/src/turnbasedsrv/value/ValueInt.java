...
public class ValueInt extends ValueBase {
	...
	public ValueInt(String value) {
		this.value = Utils.intValue(value);
	}
	 ...
	 * @param mapValue
	 */
	public ValueInt(String value, Map<Long, ValueBase> mapValue) {
		this.value = Utils.intValue(value);
	}
	...
	public void setValue(ValueBase value) {
		if (value.isNumberValue()) {
			this.value = (int) value.getNumberValue();
		}
	}
	...
	public ValueBase getCopy() {
		ValueInt otherValue = new ValueInt();
	...
	public ValueBase add(ValueBase other) {
		if (other.isNumberValue()) {
			this.value = (int) (this.value + other.getNumberValue());
		}
		return this;
	}
	...
	public ValueBase power(ValueBase other) {
		if (other.isNumberValue()) {
			this.value = (int) Math.pow(this.value, other.getNumberValue());
		}
		return this;
	}
	...
	public ValueBase modle(ValueBase other) {
		if (other.isNumberValue()) {
			this.value = Math.floorMod((int) this.value, (int) other.getNumberValue());
		}
		return this;
	}
	...
	public ValueBase floor() {
		this.value = (int) Math.floor(this.value);
		return this;
	}
	...
	public ValueBase ceil() {
		this.value = (int) Math.ceil(this.value);
		return this;
	}
