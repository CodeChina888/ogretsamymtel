...
public class ValueBoolean extends ValueBase {
	...
	public String getType() {
		return ValueDefine.ValueBoolean;
	}
	 ...
	 * @param mapValue
	 */
	public ValueBoolean(String value, Map<Long, ValueBase> mapValue) {
		this.value = Utils.booleanValue(value);
	}
	...
	public ValueBase getCopy() {
		ValueBoolean otherValue = new ValueBoolean();
