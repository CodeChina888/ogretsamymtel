...
public class ValueLong extends ValueBase {
	...
	public ValueLong(String value) {
		this.value = Utils.longValue(value);
	}
	 ...
	 * @param mapValue
	 */
	public ValueLong(String value, Map<Long, ValueBase> mapValue) {
		this.value = Utils.longValue(value);
	}
	...
	public void setValue(ValueBase value) {
		if (value.isNumberValue()) {
			this.value = (long) value.getNumberValue();
		}
	}
	...
	public ValueBase getCopy() {
		ValueLong otherValue = new ValueLong();
	...
	public ValueBase add(ValueBase other) {
		if (other.isNumberValue()) {
			this.value = (long) (this.value + other.getNumberValue());
		}
		return this;
	}
	...
	public ValueBase power(ValueBase other) {
		if (other.isNumberValue()) {
			this.value = (long) Math.pow(this.value, other.getNumberValue());
		}
		return this;
	}
	...
	public ValueBase floor() {
		this.value = (long) Math.floor(this.value);
		return this;
	}
	...
	public ValueBase ceil() {
		this.value = (long) Math.ceil(this.value);
		return this;
	}
	...
	public ValueBase sqrt() {
		this.value = (long) Math.sqrt(this.value);
		return this;
	}
