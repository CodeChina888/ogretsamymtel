...
@GofGenFile
public final class PartnerMirror extends MirrorPartner {
	public static final String tableName = "partner_mirror";
	...
	public PartnerMirror() {
		super();
	}

	public PartnerMirror(Record record) {
		super(record);
	}
