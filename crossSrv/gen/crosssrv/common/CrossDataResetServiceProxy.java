...
@GofGenFile
public final class CrossDataResetServiceProxy extends ProxyBase {
	public final class EnumCall{
		public static final int CrossDataResetService_update_Objects = 1;
	}
	private static final String SERV_ID = "common.DataResetService";
	 ...
	 */
	private CrossDataResetServiceProxy() {}
	...
	public Object getMethodFunction(Service service, int methodKey) {
		CrossDataResetService serv = (CrossDataResetService)service;
		switch (methodKey) {
			case EnumCall.CrossDataResetService_update_Objects: {
	 ...
	 * @return
	 */
	public static CrossDataResetServiceProxy newInstance() {
	 ...
	 * @return
	 */
	private static CrossDataResetServiceProxy createInstance(String node, String port, Object id) {
		CrossDataResetServiceProxy inst = new CrossDataResetServiceProxy();
	...
	public void update(Object... objs) {
		...
		localPort.call(immutableOnce, remote, EnumCall.CrossDataResetService_update_Objects, "CrossDataResetServiceProxy.update", new Object[] {objs});
