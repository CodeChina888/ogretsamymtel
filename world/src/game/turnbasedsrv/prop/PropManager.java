...
import game.turnbasedsrv.value.ValueInt;
...
public class PropManager extends ManagerBase {
	 ...
	 * @return
	 */
	public void addAtkPct(FightObject fightObj, int addAtkPct) {
		ValueBase atkPct = getOnePropValue(FightPropName.AtkPct.value(), fightObj);
		atkPct.addInt(addAtkPct);
		fightObj.prop.setPropValue(FightPropName.AtkPct.value(), atkPct);
	}
	 ...
	 * @param addDamAddEx
	 */
	public void addDamAddEx(FightObject fightObj, int addDamAddEx) {
		ValueBase damAddEx = getOnePropValue(FightPropName.DamAddEx.value(), fightObj);
		damAddEx.addInt(addDamAddEx);
		fightObj.prop.setPropValue(FightPropName.DamAddEx.value(), damAddEx);
	}
	 ...
	 * @return
	 */
	public void resetHpMaxHp(FightObject fightObj, int hp, int maxHp) {
		// 设置值
		...
		ValueBase valueHpCur = ValueFactory.getFightValueByName(FightPropName.HpCur.value(), String.valueOf(hp));
