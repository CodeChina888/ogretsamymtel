...
public class Prop {
	 ...
	 * 所有属性乘以指定值
	 */
	public void multiplyAllPropValue(ValueBase value) {
		for (String propName : this.mapPropValue.keySet()) {
			multiplyPropValue(propName, value);
		}
	}
	 ...
	 */
	public int getMaxHp() {
		ValueBase hpMax = getOnePropValue(FightPropName.HpMax.value());
		ValueBase hpMaxPct = getOnePropValue(FightPropName.HpMaxPct.value());
		ValueBase hpMaxEx = getOnePropValue(FightPropName.HpMaxEx.value());
