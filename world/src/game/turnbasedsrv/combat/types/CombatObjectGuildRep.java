...
public class CombatObjectGuildRep extends CombatObject {
	private HumanMirrorObject humanMirrorObj;// 挑战者镜像
	private GuildParam guildParam;// 额外数据

	public CombatObjectGuildRep(HumanMirrorObject humanMirrorObj, Port port, StageObject mapStageObj, 
	...
	public CombatObjectGuildRep(FightRecord fightRecord, Port port, StageObject mapStageObj, 
