...
public class CombatObjectCommon extends CombatObject {
	private HumanMirrorObject humanMirrorObj;// 挑战者镜像
	private PassParam passParam;// 额外数据
	
	public CombatObjectCommon(HumanMirrorObject humanMirrorObj, Port port, StageObject mapStageObj, 
	...
	public CombatObjectCommon(FightRecord fightRecord, Port port, StageObject mapStageObj, 
