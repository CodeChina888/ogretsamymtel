...
public class CombatObjectPKMirror extends CombatObject {
	private HumanMirrorObject humanMirrorObj;// 挑战者镜像
	private CompeteParam competeParam;// 额外数据
	private Param param;
	
	public CombatObjectPKMirror(Port port, StageObject mapStageObj, int stageSn, int mapSn, 
	...
	public CombatObjectPKMirror(FightRecord fightRecord, Port port, StageObject mapStageObj, 
