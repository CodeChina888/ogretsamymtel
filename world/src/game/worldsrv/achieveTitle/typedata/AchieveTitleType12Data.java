 ...
 * 主角战力达到{0}
 */
public class AchieveTitleType12Data extends AchieveTitleTypeData {

	private static AchieveTitleType12Data instance = new AchieveTitleType12Data();

	public static AchieveTitleType12Data getInstance() {
		return instance;
	}

	private AchieveTitleType12Data() {
		super(AchieveTitleTypeKey.ACHIEVE_TITLE_TYPE_12);
	}
