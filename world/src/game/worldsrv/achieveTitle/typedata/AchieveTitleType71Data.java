 ...
 * 累计进行{0}次切磋
 */
public class AchieveTitleType71Data extends AchieveTitleTypeData {

	private static AchieveTitleType71Data instance = new AchieveTitleType71Data();

	public static AchieveTitleType71Data getInstance() {
		return instance;
	}

	private AchieveTitleType71Data() {
		super(AchieveTitleTypeKey.ACHIEVE_TITLE_TYPE_71);
	}
