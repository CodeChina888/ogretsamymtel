 ...
 * 参与封印之地n次
 */
public class AchieveTitleType41Data extends AchieveTitleTypeData {

	private static AchieveTitleType41Data instance = new AchieveTitleType41Data();

	public static AchieveTitleType41Data getInstance() {
		return instance;
	}

	private AchieveTitleType41Data() {
		super(AchieveTitleTypeKey.ACHIEVE_TITLE_TYPE_41);
	}
