 ...
 * 累计元宝消费达到{0}
 */
public class AchievementType24Data extends AbstractAchievementTypeData {

	private static AchievementType24Data instance = new AchievementType24Data();

	public static AchievementType24Data getInstance() {
		return instance;
	}

	private AchievementType24Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_24);
	}
