 ...
 * 普本第{0}关达到三星
 */
public class AchievementType5Data extends AbstractAchievementTypeData {

	private static AchievementType5Data instance = new AchievementType5Data();

	public static AchievementType5Data getInstance() {
		return instance;
	}

	private AchievementType5Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_5);
	}
