 ...
 * 获得{0}个橙色伙伴
 */
public class AchievementType11Data extends AbstractAchievementTypeData {

	private static AchievementType11Data instance = new AchievementType11Data();

	public static AchievementType11Data getInstance() {
		return instance;
	}

	private AchievementType11Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_11);
	}
