 ...
 * 累计高级招募{0}次
 */
public class AchievementType23Data extends AbstractAchievementTypeData {

	private static AchievementType23Data instance = new AchievementType23Data();

	public static AchievementType23Data getInstance() {
		return instance;
	}

	private AchievementType23Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_23);
	}
