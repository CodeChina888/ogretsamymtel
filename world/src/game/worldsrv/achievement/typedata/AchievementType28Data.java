 ...
 * {0}个神兽达到{1}星
 */
public class AchievementType28Data extends AbstractAchievementTypeData {

	private static AchievementType28Data instance = new AchievementType28Data();

	public static AchievementType28Data getInstance() {
		return instance;
	}

	private AchievementType28Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_28);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = humanObj.humanSkillRecord.getAmountByGodsStar(newTarget);
