 ...
 * 通关精本第{0}关
 */
public class AchievementType4Data extends AbstractAchievementTypeData {

	private static AchievementType4Data instance = new AchievementType4Data();

	public static AchievementType4Data getInstance() {
		return instance;
	}

	private AchievementType4Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_4);
	}
