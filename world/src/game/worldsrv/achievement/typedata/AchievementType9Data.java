...
/**
 * 成就任务类型9 主角{0]个技能达到{1}级
 */
public class AchievementType9Data extends AbstractAchievementTypeData {

	private static AchievementType9Data instance = new AchievementType9Data();

	public static AchievementType9Data getInstance() {
		return instance;
	}

	private AchievementType9Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_9);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = humanObj.humanSkillRecord.getAmountBySkillLv(newTarget);
