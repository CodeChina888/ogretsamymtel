 ...
 * 累计铜币消费达到{0}
 */
public class AchievementType25Data extends AbstractAchievementTypeData {

	private static AchievementType25Data instance = new AchievementType25Data();

	public static AchievementType25Data getInstance() {
		return instance;
	}

	private AchievementType25Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_25);
	}
