 ...
 * {0}个神兽达到{1}级
 */
public class AchievementType16Data extends AbstractAchievementTypeData {

	private static AchievementType16Data instance = new AchievementType16Data();

	public static AchievementType16Data getInstance() {
		return instance;
	}

	private AchievementType16Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_16);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = humanObj.humanSkillRecord.getAmountByGodsLv(newTarget);
