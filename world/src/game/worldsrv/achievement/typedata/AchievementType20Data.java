 ...
 * 主角{0}件装备进阶至{1}级
 */
public class AchievementType20Data extends AbstractAchievementTypeData {

	private static AchievementType20Data instance = new AchievementType20Data();

	public static AchievementType20Data getInstance() {
		return instance;
	}

	private AchievementType20Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_20);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = ItemBodyManager.inst().getEquipNumByAdvancedLv(humanObj, newTarget);
