 ...
 * {0}个伙伴升至{1}级
 */
public class AchievementType17Data extends AbstractAchievementTypeData {

	private static AchievementType17Data instance = new AchievementType17Data();

	public static AchievementType17Data getInstance() {
		return instance;
	}

	private AchievementType17Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_17);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = PartnerManager.inst().hasNumInLevel(humanObj, newTarget);
