 ...
 * 精本第{0}关达到三星
 */
public class AchievementType6Data extends AbstractAchievementTypeData {

	private static AchievementType6Data instance = new AchievementType6Data();

	public static AchievementType6Data getInstance() {
		return instance;
	}

	private AchievementType6Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_6);
	}
	...
	public boolean doProgress(HumanObject humanObj, Achievement achieve, int progress) {
		...
		// 副本特殊处理：progress为当前的关卡sn，achieve.getTarget为目标关卡sn
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		if (InstanceManager.inst().isInstPassPerfect(humanObj, newTarget)) {
