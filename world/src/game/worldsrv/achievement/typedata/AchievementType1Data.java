 ...
 * 普本第{0}章全三星通关
 */
public class AchievementType1Data extends AbstractAchievementTypeData {

	private static AchievementType1Data instance = new AchievementType1Data();

	public static AchievementType1Data getInstance() {
		return instance;
	}

	private AchievementType1Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_1);
	}
