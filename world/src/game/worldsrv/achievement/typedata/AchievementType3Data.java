 ...
 * 通关普本第{0}关
 */
public class AchievementType3Data extends AbstractAchievementTypeData {

	private static AchievementType3Data instance = new AchievementType3Data();

	public static AchievementType3Data getInstance() {
		return instance;
	}

	private AchievementType3Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_3);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		if (InstanceManager.inst().isInstPass(humanObj, newTarget)) {
