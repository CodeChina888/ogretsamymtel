 ...
 * 主角{0}件装备强化至{1}级
 */
public class AchievementType21Data extends AbstractAchievementTypeData {

	private static AchievementType21Data instance = new AchievementType21Data();

	public static AchievementType21Data getInstance() {
		return instance;
	}

	private AchievementType21Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_21);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = ItemBodyManager.inst().getEquipNumByReinforceLv(humanObj, newTarget);
