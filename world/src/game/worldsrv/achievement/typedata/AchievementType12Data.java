 ...
 * 获得{0}个红色伙伴
 */
public class AchievementType12Data extends AbstractAchievementTypeData {

	private static AchievementType12Data instance = new AchievementType12Data();

	public static AchievementType12Data getInstance() {
		return instance;
	}

	private AchievementType12Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_12);
	}
