 ...
 * {0}个伙伴升至{1}星
 */
public class AchievementType19Data extends AbstractAchievementTypeData {

	private static AchievementType19Data instance = new AchievementType19Data();

	public static AchievementType19Data getInstance() {
		return instance;
	}

	private AchievementType19Data() {
		super(AchievementTypeKey.ACHIEVEMENT_TYPE_19);
	}
	...
	public boolean lvUp(HumanObject humanObj, Achievement achieve, ConfAchievement confAchieve) {
		...
		int newProgress = PartnerManager.inst().hasNumStart(humanObj, newTarget);
