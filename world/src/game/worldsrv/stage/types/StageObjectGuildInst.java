...
import game.turnbasedsrv.combat.types.CombatObjectGuildInst;
 ...
 * @author Neak
 */
public class StageObjectGuildInst extends StageObject{
    ...
    public StageObjectGuildInst(StagePort port, long stageId, int stageSn, int mapSn, int fightType, Param param) {
        ...
        this.combatObj = new CombatObjectGuildInst(port, this, stageSn, mapSn, fightType, param);
    }
