...
@GofGenFile
public final class MergeCave extends EntityBase {
	public static final String tableName = "merge_cave";
	...
	public static final class K {
		...
		public static final String CaveJsonStr = "CaveJsonStr";	//仙域json字符串
		public static final String Flag = "Flag";	//处理标记：0-未处理 1-已处理
	}
	...
	public MergeCave(Record record) {
		super(record);
	}
	 ...
	 * 仙域json字符串
	 */
	public String getCaveJsonStr() {
		return record.get("CaveJsonStr");
	}

	public void setCaveJsonStr(final String CaveJsonStr) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("CaveJsonStr", CaveJsonStr);
