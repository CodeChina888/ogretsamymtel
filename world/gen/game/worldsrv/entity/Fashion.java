...
@GofGenFile
public final class Fashion extends EntityBase {
	...
	public static final class K {
		...
		public static final String fashionSn = "fashionSn";	//已获得的时装sn
		public static final String fashionLimitTime = "fashionLimitTime";	//对应时装sn的到期时间，-1为永久
		public static final String HenshinSn = "HenshinSn";	//已经获得的变装卡snList(1,2,3)
		public static final String HenshinLimitTime = "HenshinLimitTime";	//对应变装sn的到期时间，-1为永久
	}
	 ...
	 * 已获得的时装sn
	 */
	public String getFashionSn() {
		return record.get("fashionSn");
	}

	public void setFashionSn(final String fashionSn) {
		//更新前的数据状态
		int statusOld = record.getStatus();
	 ...
	 * 对应时装sn的到期时间，-1为永久
	 */
	public String getFashionLimitTime() {
		return record.get("fashionLimitTime");
	}

	public void setFashionLimitTime(final String fashionLimitTime) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("fashionLimitTime", fashionLimitTime);
	...
	/**
	 * 已经获得的变装卡snList(1,2,3)
	 */
	public String getHenshinSn() {
		return record.get("HenshinSn");
	}

	public void setHenshinSn(final String HenshinSn) {
		//更新前的数据状态
		int statusOld = record.getStatus();
	 ...
	 * 对应变装sn的到期时间，-1为永久
	 */
	public String getHenshinLimitTime() {
		return record.get("HenshinLimitTime");
	}

	public void setHenshinLimitTime(final String HenshinLimitTime) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("HenshinLimitTime", HenshinLimitTime);
