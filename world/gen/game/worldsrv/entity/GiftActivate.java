...
@GofGenFile
public final class GiftActivate extends EntityBase {
	public static final String tableName = "gift_activate";
	...
	public static final class K {
		...
		public static final String GiftKey = "GiftKey";	//已经使用过的礼包码
	}
	...
	public GiftActivate(Record record) {
		super(record);
	}
	...
	public String getGiftKey() {
		return record.get("GiftKey");
	}

	public void setGiftKey(final String GiftKey) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("GiftKey", GiftKey);
