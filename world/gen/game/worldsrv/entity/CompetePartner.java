...
@GofGenFile
public final class CompetePartner extends MirrorPartner {
	public static final String tableName = "compete_partner";
	...
	public CompetePartner() {
		super();
	}

	public CompetePartner(Record record) {
		super(record);
	}
