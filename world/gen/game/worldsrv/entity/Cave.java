...
@GofGenFile
public final class Cave extends EntityBase {
	public static final String tableName = "cave";
	...
	public static final class K {
		...
		public static final String HumanID = "HumanID";	//占领者ID
		...
		public static final String Sn = "Sn";	//洞穴sn
		public static final String name = "name";	//人物名
		public static final String isOwn = "isOwn";	//是否被占领
		public static final String ownTime = "ownTime";	//占领时间时间戳
		public static final String ExpOwnTime = "ExpOwnTime";	//预期占领到某个时间
		public static final String DelayCount = "DelayCount";	//延时档次，对应Cave表cdTime下标
		public static final String BeRobNum = "BeRobNum";	//被抢夺金币数
		public static final String RobCount = "RobCount";	//被抢次数
		public static final String RobHumanList = "RobHumanList";	//抢夺的人物id列表
	}
	...
	public boolean isIsOwn() {
		return record.<Integer>get("isOwn") == 1;
	}
	 ...
	 * 预期占领到某个时间
	 */
	public long getExpOwnTime() {
		return record.get("ExpOwnTime");
	}

	public void setExpOwnTime(final long ExpOwnTime) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ExpOwnTime", ExpOwnTime);
	...
	/**
	 * 延时档次，对应Cave表cdTime下标
	 */
	public int getDelayCount() {
		return record.get("DelayCount");
	}
	...
	public void setDelayCount(final int DelayCount) {
		...
		//更新属性
		record.set("DelayCount", DelayCount);
	...
	public int getBeRobNum() {
		return record.get("BeRobNum");
	}

	public void setBeRobNum(final int BeRobNum) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("BeRobNum", BeRobNum);
	...
	public int getRobCount() {
		return record.get("RobCount");
	}

	public void setRobCount(final int RobCount) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("RobCount", RobCount);
	 ...
	 * 抢夺的人物id列表
	 */
	public String getRobHumanList() {
		return record.get("RobHumanList");
	}

	public void setRobHumanList(final String RobHumanList) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("RobHumanList", RobHumanList);
