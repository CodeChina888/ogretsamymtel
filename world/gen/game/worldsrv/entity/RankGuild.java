...
@GofGenFile
public final class RankGuild extends EntityBase {
	public static final String tableName = "rank_guild";
	...
	public static final class K {
		...
		public static final String HumanId = "HumanId";	//会长角色Id
		...
		public static final String GuildExp = "GuildExp";	//工会经验
		public static final String GuildLeaderName = "GuildLeaderName";	//会长名字
		public static final String GuildMember = "GuildMember";	//工会现有人数
		public static final String GuildIcon = "GuildIcon";	//工会图标
	}
	...
	public RankGuild(Record record) {
		super(record);
	}
	...
	public int getGuildMember() {
		return record.get("GuildMember");
	}

	public void setGuildMember(final int GuildMember) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("GuildMember", GuildMember);
