...
@GofGenFile
public final class CavePartner extends MirrorPartner {
	public static final String tableName = "cave_partner";
	...
	public static final class K extends SuperK {
		...
		public static final String CaveId = "CaveId";	//洞穴id
		public static final String PartnerId = "PartnerId";	//伙伴id
	}
	...
	public CavePartner(Record record) {
		super(record);
	}
	...
	public long getCaveId() {
		return record.get("CaveId");
	}

	public void setCaveId(final long CaveId) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("CaveId", CaveId);
