...
@GofGenFile
public final class ActivityGlobal extends EntityBase {
	public static final String tableName = "activity_global";
	...
	public static final class K {
		...
		public static final String FundBuyCount = "FundBuyCount";	//全服购买次数
	}
	...
	public ActivityGlobal(Record record) {
		super(record);
	}
	 ...
	 * 全服购买次数
	 */
	public int getFundBuyCount() {
		return record.get("FundBuyCount");
	}

	public void setFundBuyCount(final int FundBuyCount) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("FundBuyCount", FundBuyCount);
