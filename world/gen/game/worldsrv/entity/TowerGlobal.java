...
@GofGenFile
public final class TowerGlobal extends EntityBase {
	public static final String tableName = "tower_global";
	...
	public static final class K {
		...
		public static final String layerPass = "layerPass";	//各层通过人数记录层数：1,2,3,4,5,6...max+1
		public static final String firstPassState = "firstPassState";	//爬塔每层首次通过状态0|0|0,0|0|0(0未被通过，1通过，|区分难度)
	...
	public TowerGlobal(Record record) {
		super(record);
	}
	...
	/**
	 * 各层通过人数记录层数：1,2,3,4,5,6...max+1
	 */
	public String getLayerPass() {
		return record.get("layerPass");
	}

	public void setLayerPass(final String layerPass) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("layerPass", layerPass);
	...
	/**
	 * 爬塔每层首次通过状态0|0|0,0|0|0(0未被通过，1通过，|区分难度)
	 */
	public String getFirstPassState() {
		return record.get("firstPassState");
	}

	public void setFirstPassState(final String firstPassState) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("firstPassState", firstPassState);
