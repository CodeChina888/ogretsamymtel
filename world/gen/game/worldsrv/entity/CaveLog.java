...
@GofGenFile
public final class CaveLog extends EntityBase {
	public static final String tableName = "cavelog";
	...
	public static final class K {
		...
		public static final String CaveId = "CaveId";	//仙府ID
		public static final String Log = "Log";	//仙府日志
		public static final String HumanId = "HumanId";	//挑战者ID
		public static final String beChallegeHumanId = "beChallegeHumanId";	//被挑战者ID
		public static final String isWin = "isWin";	//被挑战者是否胜利
		public static final String HumanName = "HumanName";	//挑战者玩家姓名
		public static final String Combat = "Combat";	//挑战者玩家战斗力
		public static final String BattleType = "BattleType";	//战斗类型
		public static final String Time = "Time";	//发生时间
		public static final String RobCoin = "RobCoin";	//被抢夺铜币数量
		public static final String OwnTime = "OwnTime";	//占领时间
	 ...
	 * 被挑战者ID
	 */
	public long getBeChallegeHumanId() {
		return record.get("beChallegeHumanId");
	}

	public void setBeChallegeHumanId(final long beChallegeHumanId) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("beChallegeHumanId", beChallegeHumanId);
	...
	public boolean isIsWin() {
		return record.<Integer>get("isWin") == 1;
	}
	...
	public void setBattleType(final int BattleType) {
		...
		//更新属性
		record.set("BattleType", BattleType);
	...
	public int getRobCoin() {
		return record.get("RobCoin");
	}

	public void setRobCoin(final int RobCoin) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("RobCoin", RobCoin);
