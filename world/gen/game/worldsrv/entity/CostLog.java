...
@GofGenFile
public final class CostLog extends EntityBase {
	public static final String tableName = "cost_log";
	...
	public static final class K {
		...
		public static final String Type = "Type";	//消费类型
		public static final String OldMoney = "OldMoney";	//消费前
		public static final String Num = "Num";	//数量
		public static final String NewMoney = "NewMoney";	//消费后
	...
	public long getOldMoney() {
		return record.get("OldMoney");
	}

	public void setOldMoney(final long OldMoney) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("OldMoney", OldMoney);
	...
	public long getNewMoney() {
		return record.get("NewMoney");
	}

	public void setNewMoney(final long NewMoney) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("NewMoney", NewMoney);
