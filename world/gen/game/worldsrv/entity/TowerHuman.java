...
@GofGenFile
public final class TowerHuman extends MirrorHuman {
	public static final String tableName = "tower_human";
	...
	public static final class K extends SuperK {
		...
		public static final String RecordTime = "RecordTime";	//记录玩家插入时间
	}
	...
	public TowerHuman(Record record) {
		super(record);
	}
