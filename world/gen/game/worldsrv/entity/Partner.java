...
@GofGenFile
public final class Partner extends Unit {
	...
	public static final class K extends SuperK {
		...
		public static final String AdvLevel = "AdvLevel";	//进阶等级
		public static final String RelationActive = "RelationActive";	//激活的羁绊缘分sn
		public static final String ServantList = "ServantList";	//护法的ID列表
		public static final String ServantSnList = "ServantSnList";	//护法的SN列表
		public static final String isServant = "isServant";	//是否是护法
		public static final String PartnerSkill = "PartnerSkill";	//伙伴技能
	}
	...
	public Partner() {
		...
		setStar(0);
		setAdvLevel(0);
		setServantList("[-1,-1,-1]");
		setServantSnList("[-1,-1,-1]");
		setIsServant(false);
		setPartnerSkill("[]");
	}

	public Partner(Record record) {
		super(record);
	}
	 ...
	 * 护法的ID列表
	 */
	public String getServantList() {
		return record.get("ServantList");
	}

	public void setServantList(final String ServantList) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ServantList", ServantList);
	 ...
	 * 护法的SN列表
	 */
	public String getServantSnList() {
		return record.get("ServantSnList");
	}

	public void setServantSnList(final String ServantSnList) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ServantSnList", ServantSnList);
	...
	public boolean isIsServant() {
		return record.<Integer>get("isServant") == 1;
	}

	public void setIsServant(boolean isServant) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("isServant", isServant ? 1 : 0);
	 ...
	 * 伙伴技能
	 */
	public String getPartnerSkill() {
		return record.get("PartnerSkill");
	}

	public void setPartnerSkill(final String PartnerSkill) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("PartnerSkill", PartnerSkill);
