...
@GofGenFile
public final class IOSPayOrder extends EntityBase {
	public static final String tableName = "ios_pay_order";
	...
	public static final class K {
		...
		public static final String ProductSn = "ProductSn";	//商品SN
		public static final String Order = "Order";	//订单号
		public static final String ReceiptMd5 = "ReceiptMd5";	//订单收据MD5
		public static final String OriginReceipt = "OriginReceipt";	//订单原始收据
		public static final String CheckReceipt = "CheckReceipt";	//订单校验后回执
	...
	public IOSPayOrder(Record record) {
		super(record);
	}
	...
	public int getProductSn() {
		return record.get("ProductSn");
	}

	public void setProductSn(final int ProductSn) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ProductSn", ProductSn);
	...
	public String getReceiptMd5() {
		return record.get("ReceiptMd5");
	}

	public void setReceiptMd5(final String ReceiptMd5) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ReceiptMd5", ReceiptMd5);
	 ...
	 * 订单原始收据
	 */
	public String getOriginReceipt() {
		return record.get("OriginReceipt");
	}

	public void setOriginReceipt(final String OriginReceipt) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("OriginReceipt", OriginReceipt);
	 ...
	 * 订单校验后回执
	 */
	public String getCheckReceipt() {
		return record.get("CheckReceipt");
	}

	public void setCheckReceipt(final String CheckReceipt) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("CheckReceipt", CheckReceipt);
