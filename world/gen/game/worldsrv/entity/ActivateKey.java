...
@GofGenFile
public final class ActivateKey extends EntityBase {
	public static final String tableName = "activate_key";
	...
	public static final class K {
		...
		public static final String ActivateKey = "ActivateKey";	//激活码
		public static final String Account = "Account";	//使用者的账号
	}
	...
	public ActivateKey(Record record) {
		super(record);
	}
	...
	public String getActivateKey() {
		return record.get("ActivateKey");
	}

	public void setActivateKey(final String ActivateKey) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ActivateKey", ActivateKey);
