...
@GofGenFile
public final class RedPacket extends EntityBase {
	public static final String tableName = "red_packet";
	...
	public static final class K {
		...
		public static final String Sn = "Sn";	//红包Sn
		public static final String HumanId = "HumanId";	//发红包的人
		public static final String Nums = "Nums";	//红包个数
		public static final String BeginTime = "BeginTime";	//开始时间戳
		public static final String EndTime = "EndTime";	//结束时间戳
		public static final String Gainsituation = "Gainsituation";	//获取的情况
		public static final String SurplusDItems = "SurplusDItems";	//红包中剩余物品个数列表
		public static final String ItemSn = "ItemSn";	//红包中物品Sn
	}
	...
	public RedPacket(Record record) {
		super(record);
	}
	...
	public void setBeginTime(final long BeginTime) {
		...
		//更新属性
		record.set("BeginTime", BeginTime);
	 ...
	 * 获取的情况
	 */
	public String getGainsituation() {
		return record.get("Gainsituation");
	}

	public void setGainsituation(final String Gainsituation) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("Gainsituation", Gainsituation);
	 ...
	 * 红包中剩余物品个数列表
	 */
	public String getSurplusDItems() {
		return record.get("SurplusDItems");
	}

	public void setSurplusDItems(final String SurplusDItems) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("SurplusDItems", SurplusDItems);
	...
	public int getItemSn() {
		return record.get("ItemSn");
	}

	public void setItemSn(final int ItemSn) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ItemSn", ItemSn);
