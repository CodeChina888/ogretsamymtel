...
@GofGenFile
public final class ActServerCompetition extends EntityBase {
	public static final String tableName = "actservercompetition";
	...
	public static final class K {
		...
		public static final String Type = "Type";	//排行类型
		public static final String ParamJSON = "ParamJSON";	//参数类型
	}
	...
	public ActServerCompetition() {
		super();
	}

	public ActServerCompetition(Record record) {
		super(record);
	}
	...
	public void setParamJSON(final String ParamJSON) {
		...
		//更新属性
		record.set("ParamJSON", ParamJSON);
