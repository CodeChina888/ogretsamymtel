...
@GofGenFile
public final class Backlog extends EntityBase {
	...
	public static final class K {
		...
		public static final String Type = "Type";	//待办事项类型
		public static final String ParamJSON = "ParamJSON";	//待办事项参数JSON
	}
