...
@GofGenFile
public final class HumanSimple extends EntityBase {
	public static final String tableName = "human_simple";
	...
	public static final class K {
		...
		public static final String Content = "Content";	//  玩家最后一次登陆时间
	}
	...
	public HumanSimple(Record record) {
		super(record);
	}
