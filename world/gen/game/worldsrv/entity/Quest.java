...
@GofGenFile
public final class Quest extends EntityBase {
	...
	public static final class K {
		...
		public static final String Name = "Name";	//玩家名字
		public static final String SevenQuestOverReissue = "SevenQuestOverReissue";	//七天奖励是否补发了
		public static final String NormalJSON = "NormalJSON";	//普通任务
		public static final String DailyJSON = "DailyJSON";	//每日任务
		public static final String SevenJSON = "SevenJSON";	//开服七天任务
	}
	...
	public Quest() {
		super();
		setSevenQuestOverReissue(false);
		setNormalJSON("[]");
		setDailyJSON("[]");
		setSevenJSON("[]");
	}

	public Quest(Record record) {
		super(record);
	}
	 ...
	 * 七天奖励是否补发了
	 */
	public boolean isSevenQuestOverReissue() {
		return record.<Integer>get("SevenQuestOverReissue") == 1;
	}

	public void setSevenQuestOverReissue(boolean SevenQuestOverReissue) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("SevenQuestOverReissue", SevenQuestOverReissue ? 1 : 0);
	...
	public String getNormalJSON() {
		return record.get("NormalJSON");
	}

	public void setNormalJSON(final String NormalJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("NormalJSON", NormalJSON);
	...
	public String getDailyJSON() {
		return record.get("DailyJSON");
	}

	public void setDailyJSON(final String DailyJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("DailyJSON", DailyJSON);
	 ...
	 * 开服七天任务
	 */
	public String getSevenJSON() {
		return record.get("SevenJSON");
	}

	public void setSevenJSON(final String SevenJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("SevenJSON", SevenJSON);
