...
@GofGenFile
public final class GuildImmoLog extends EntityBase {
	public static final String tableName = "guild_immo_log";
	...
	public static final class K {
		...
		public static final String logTypeKey = "logTypeKey";	//1献祭，2挑战，3日常
		public static final String HumanId = "HumanId";	//人物id
		public static final String AptitudeKey = "AptitudeKey";	//资质
		public static final String Handle = "Handle";	//1进入公会，2退出公会，3任命会长，4任命副会长[// 日常操作日志]
		public static final String Time = "Time";	//献祭时间
		public static final String HumanName = "HumanName";	//人物名字
		public static final String Content = "Content";	//日志信息[/ 挑战日志]
		public static final String Immotype = "Immotype";	//记录献祭消耗类型[/ 公会建设日志（献祭）]
	}
	...
	public GuildImmoLog(Record record) {
		super(record);
	}
	 ...
	 * 1献祭，2挑战，3日常
	 */
	public int getLogTypeKey() {
		return record.get("logTypeKey");
	}

	public void setLogTypeKey(final int logTypeKey) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("logTypeKey", logTypeKey);
	...
	/**
	 * 1进入公会，2退出公会，3任命会长，4任命副会长[// 日常操作日志]
	 */
	...
	public int getImmotype() {
		return record.get("Immotype");
	}

	public void setImmotype(final int Immotype) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("Immotype", Immotype);
