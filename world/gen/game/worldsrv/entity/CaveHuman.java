...
@GofGenFile
public final class CaveHuman extends MirrorHuman {
	public static final String tableName = "cave_human";
	...
	public static final class K extends SuperK {
		...
		public static final String GuiLdId = "GuiLdId";	//工会id
		public static final String GuiLdName = "GuiLdName";	//工会名
	}
	...
	public CaveHuman(Record record) {
		super(record);
	}
