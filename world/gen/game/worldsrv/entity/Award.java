...
@GofGenFile
public final class Award extends EntityBase {
	...
	public static final class K {
		...
		public static final String ActLevelRace = "ActLevelRace";	//等级竞技奖励{奖励sn:1,排行rk:1,领取dr:2,...}
		public static final String ActCombatRace = "ActCombatRace";	//战力竞技奖励{奖励sn:1,排行rk:1,领取dr:2,...}
	}
	...
	/**
	 * 等级竞技奖励{奖励sn:1,排行rk:1,领取dr:2,...}
	 */
	public String getActLevelRace() {
		return record.get("ActLevelRace");
	}

	public void setActLevelRace(final String ActLevelRace) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ActLevelRace", ActLevelRace);
	...
	/**
	 * 战力竞技奖励{奖励sn:1,排行rk:1,领取dr:2,...}
	 */
	public String getActCombatRace() {
		return record.get("ActCombatRace");
	}

	public void setActCombatRace(final String ActCombatRace) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ActCombatRace", ActCombatRace);
