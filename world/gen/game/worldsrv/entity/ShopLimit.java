...
@GofGenFile
public final class ShopLimit extends EntityBase {
	public static final String tableName = "shoplimit";
	...
	public static final class K {
		...
		public static final String ShopSn = "ShopSn";	//限购商品的商品sn
		public static final String NumSell = "NumSell";	//目前已经售出数量
	}
	...
	public ShopLimit(Record record) {
		super(record);
	}
	...
	public int getShopSn() {
		return record.get("ShopSn");
	}

	public void setShopSn(final int ShopSn) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ShopSn", ShopSn);
	...
	public int getNumSell() {
		return record.get("NumSell");
	}

	public void setNumSell(final int NumSell) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("NumSell", NumSell);
