...
@GofGenFile
public final class Notice extends EntityBase {
	...
	public static final class K {
		...
		public static final String NoticeId = "NoticeId";	//公告id
		public static final String Title = "Title";	//公告标题
		public static final String Content = "Content";	//公告内容
		public static final String Type = "Type";	//公告type
		public static final String Timestamp = "Timestamp";	//公告生效时间戳
		public static final String IntervalTime = "IntervalTime";	//公告循环间隔
		public static final String TimesEnd = "TimesEnd";	//公告结束时间戳
		public static final String Count = "Count";	//公告循环次数
		public static final String Outmoded = "Outmoded";	//公告是否过期，0未过期，1过期
		public static final String EventKey = "EventKey";	//平台的标识
	}
	...
	public long getIntervalTime() {
		return record.get("IntervalTime");
	}
	...
	public void setIntervalTime(final long IntervalTime) {
		...
		//更新属性
		record.set("IntervalTime", IntervalTime);
	...
	public long getTimesEnd() {
		return record.get("TimesEnd");
	}

	public void setTimesEnd(final long TimesEnd) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("TimesEnd", TimesEnd);
	...
	public int getOutmoded() {
		return record.get("Outmoded");
	}

	public void setOutmoded(final int Outmoded) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("Outmoded", Outmoded);
