...
@GofGenFile
public final class PayCheckCode extends EntityBase {
	public static final String tableName = "pay_check_code";
	...
	public static final class K {
		...
		public static final String CheckCode = "CheckCode";	//校验码
		public static final String Time = "Time";	//生成时间
	...
	public PayCheckCode(Record record) {
		super(record);
	}
	...
	public void setCheckCode(final String CheckCode) {
		...
		//更新属性
		record.set("CheckCode", CheckCode);
