...
@GofGenFile
public final class TowerPartner extends MirrorPartner {
	public static final String tableName = "tower_partner";
	...
	public static final class K extends SuperK {
		...
		public static final String RecordTime = "RecordTime";	//记录伙伴插入时间
	}
	...
	public TowerPartner(Record record) {
		super(record);
	}
