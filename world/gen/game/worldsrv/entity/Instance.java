...
@GofGenFile
public final class Instance extends EntityBase {
	...
	public static final class K {
		...
		public static final String HumanId = "HumanId";	//所属玩家ID
		public static final String HumanName = "HumanName";	//所属玩家名字
		public static final String ChapterSn = "ChapterSn";	//章节SN
		public static final String StarAll = "StarAll";	//章节总星数
		public static final String BoxJSON = "BoxJSON";	//章节宝箱领取状态{star:EAwardType}(0不能领，1可领取，2已领取)
		public static final String StarJSON = "StarJSON";	//下属副本通关星数{instSn:star}
		public static final String FightJSON = "FightJSON";	//下属副本已挑战次数{instSn:num}
		public static final String ResetJSON = "ResetJSON";	//下属副本已重置次数{instSn:num}
	...
	public int getStarAll() {
		return record.get("StarAll");
	}

	public void setStarAll(final int StarAll) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("StarAll", StarAll);
	...
	/**
	 * 章节宝箱领取状态{star:EAwardType}(0不能领，1可领取，2已领取)
	 */
	public String getBoxJSON() {
		return record.get("BoxJSON");
	}

	public void setBoxJSON(final String BoxJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("BoxJSON", BoxJSON);
	...
	/**
	 * 下属副本通关星数{instSn:star}
	 */
	public String getStarJSON() {
		return record.get("StarJSON");
	}

	public void setStarJSON(final String StarJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("StarJSON", StarJSON);
	...
	/**
	 * 下属副本已挑战次数{instSn:num}
	 */
	public String getFightJSON() {
		return record.get("FightJSON");
	}

	public void setFightJSON(final String FightJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("FightJSON", FightJSON);
	...
	/**
	 * 下属副本已重置次数{instSn:num}
	 */
	public String getResetJSON() {
		return record.get("ResetJSON");
	}

	public void setResetJSON(final String ResetJSON) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ResetJSON", ResetJSON);
