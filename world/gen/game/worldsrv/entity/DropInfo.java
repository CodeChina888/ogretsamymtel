...
@GofGenFile
public final class DropInfo extends EntityBase {
	public static final String tableName = "dropinfo";
	...
	public static final class K {
		...
		public static final String CountType = "CountType";	//计数类型 {1:0,2:0,3:0......}
	}
	...
	public void setCountType(final String CountType) {
		...
		//更新属性
		record.set("CountType", CountType);
