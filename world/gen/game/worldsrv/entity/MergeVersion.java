...
@GofGenFile
public final class MergeVersion extends EntityBase {
	public static final String tableName = "merge_version";
	...
	public static final class K {
		...
		public static final String version = "version";	//版本日期
		public static final String updatedVersion = "updatedVersion";	//当前已经执行同步版本日期
	}
	...
	public MergeVersion(Record record) {
		super(record);
	}
	...
	public String getUpdatedVersion() {
		return record.get("updatedVersion");
	}

	public void setUpdatedVersion(final String updatedVersion) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("updatedVersion", updatedVersion);
