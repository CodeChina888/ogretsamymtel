...
@GofGenFile
public final class ActivityHumanData extends EntityBase {
	public static final String tableName = "activity_humandata";
	...
	public static final class K {
		...
		public static final String Sn = "Sn";	//数据sn
		public static final String Aid = "Aid";	//活动编号,如果活动编号为0,则存储一条数据就够了
		public static final String NumValue = "NumValue";	//数值数据
		public static final String StrValue = "StrValue";	//字符数据
	}
	...
	public ActivityHumanData() {
		super();
		setNumValue(0);
	}

	public ActivityHumanData(Record record) {
		super(record);
	}
	...
	public void setActivityId(final int ActivityId) {
		...
		//更新属性
		record.set("ActivityId", ActivityId);
	...
	/**
	 * 活动编号,如果活动编号为0,则存储一条数据就够了
	 */
	public int getAid() {
		return record.get("Aid");
	}
	...
	public long getNumValue() {
		return record.get("NumValue");
	}

	public void setNumValue(final long NumValue) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("NumValue", NumValue);
