...
@GofGenFile
public final class InstRes extends EntityBase {
	public static final String tableName = "inst_resource";
	...
	public static final class K {
		...
		public static final String StarInfo = "StarInfo";	//记录星数{sn:starNum...}
		public static final String ResInfo = "ResInfo";	//记录资源副本信息{type:{diff:num,...}}
	}
	...
	public String getStarInfo() {
		return record.get("StarInfo");
	}

	public void setStarInfo(final String StarInfo) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("StarInfo", StarInfo);
	...
	/**
	 * 记录资源副本信息{type:{diff:num,...}}
	 */
	public String getResInfo() {
		return record.get("ResInfo");
	}

	public void setResInfo(final String ResInfo) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ResInfo", ResInfo);
