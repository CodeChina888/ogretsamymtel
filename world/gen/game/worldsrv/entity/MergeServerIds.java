...
@GofGenFile
public final class MergeServerIds extends EntityBase {
	public static final String tableName = "merge_server_ids";
	...
	public static final class K {
		...
		public static final String serverIds = "serverIds";	//已合并服务器id列表
	}
	...
	public MergeServerIds() {
		super();
	}

	public MergeServerIds(Record record) {
		super(record);
	}
	...
	public String getServerIds() {
		return record.get("serverIds");
	}

	public void setServerIds(final String serverIds) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("serverIds", serverIds);
