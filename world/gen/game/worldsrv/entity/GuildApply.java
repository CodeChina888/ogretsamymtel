...
@GofGenFile
public final class GuildApply extends EntityBase {
	public static final String tableName = "guild_apply";
	...
	public static final class K {
		...
		public static final String GuildLevel = "GuildLevel";	//会员ID[HumanId]
		public static final String GuildId = "GuildId";	//公会id
		public static final String HumanName = "HumanName";	//会员名字
		public static final String GuilLv = "GuilLv";	//当前等级
		public static final String GuilCombat = "GuilCombat";	//战斗力
		public static final String ApplyTime = "ApplyTime";	//申请时间
		public static final String HumanSn = "HumanSn";	//人物sn
		public static final String AptitudeKey = "AptitudeKey";	//资质
		public static final String HumanId = "HumanId";	//申请人id
	}
	...
	public GuildApply(Record record) {
		super(record);
	}
	...
	public void setGuildLevel(final long GuildLevel) {
		//更新前的数据状态
		int statusOld = record.getStatus();
	 ...
	 * 当前等级
	 */
	public int getGuilLv() {
		return record.get("GuilLv");
	}

	public void setGuilLv(final int GuilLv) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("GuilLv", GuilLv);
	 ...
	 * 战斗力
	 */
	public int getGuilCombat() {
		return record.get("GuilCombat");
	}

	public void setGuilCombat(final int GuilCombat) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("GuilCombat", GuilCombat);
	...
	public long getApplyTime() {
		return record.get("ApplyTime");
	}

	public void setApplyTime(final long ApplyTime) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("ApplyTime", ApplyTime);
	 ...
	 * 人物sn
	 */
	public int getHumanSn() {
		return record.get("HumanSn");
	}

	public void setHumanSn(final int HumanSn) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("HumanSn", HumanSn);
	...
	public int getAptitudeKey() {
		return record.get("AptitudeKey");
	}

	public void setAptitudeKey(final int AptitudeKey) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("AptitudeKey", AptitudeKey);
