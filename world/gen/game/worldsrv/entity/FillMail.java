...
@GofGenFile
public final class FillMail extends EntityBase {
	public static final String tableName = "fill_mail";
	...
	public static final class K {
		...
		public static final String Type = "Type";	//类型，0全服，1分服，2创觉时间
		public static final String ServerId = "ServerId";	//邮件属于哪分服，只有类型是分服时才有用
		public static final String SendTime = "SendTime";	//GM发送时间
		public static final String StartTime = "StartTime";	//可领取时间
		public static final String EndTime = "EndTime";	//有效期截止时间戳
		public static final String SysSendTime = "SysSendTime";	//系统发送给玩家的时间
		public static final String ItemJSON = "ItemJSON";	//物品列表
	...
	public long getSysSendTime() {
		return record.get("SysSendTime");
	}

	public void setSysSendTime(final long SysSendTime) {
		//更新前的数据状态
		int statusOld = record.getStatus();
		
		//更新属性
		record.set("SysSendTime", SysSendTime);
