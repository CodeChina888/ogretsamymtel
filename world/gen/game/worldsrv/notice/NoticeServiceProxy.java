...
@GofGenFile
public final class NoticeServiceProxy extends ProxyBase {
	public final class EnumCall{
		public static final int NoticeService_addNotice_String_String_int_long_long_long_String = 1;
	}
	private static final String SERV_ID = "worldsrv.notice.NoticeService";
	...
	public Object getMethodFunction(Service service, int methodKey) {
		NoticeService serv = (NoticeService)service;
		switch (methodKey) {
			case EnumCall.NoticeService_addNotice_String_String_int_long_long_long_String: {
				return (GofFunction7<String, String, Integer, Long, Long, Long, String>)serv::addNotice;
			}
			default: break;
		}
		return null;
	 ...
	 * @return
	 */
	public static NoticeServiceProxy newInstance() {
	 ...
	 * @return
	 */
	private static NoticeServiceProxy createInstance(String node, String port, Object id) {
		NoticeServiceProxy inst = new NoticeServiceProxy();
	...
	public void addNotice(String title, String content, int type, long timestamp, long timeEnd, long intervalTime, String eventKey) {
		...
		localPort.call(immutableOnce, remote, EnumCall.NoticeService_addNotice_String_String_int_long_long_long_String, "NoticeServiceProxy.addNotice", new Object[] {title, content, type, timestamp, timeEnd, intervalTime, eventKey});
