...
/**
 * 参数传递简单包装对象 当传递参数数量不确定时，可以使用本类。 设置值：new Param("k1", v1, "k2", v2); new
 * Param().put("k1", v1).put("k2", v2); 获取值：Human m = param.get("human");
 * //这里会自动转换类型，无需添加(User)显示强转
 */
public class Param implements ISerilizable {
	...
	public <K> K getDefault(String key, K valDefault) {
