...
@GofGenFile
public final class CrossIdAllotServiceProxy extends ProxyBase {
	public final class EnumCall{
		public static final int CrossIdAllotService_apply_int = 1;
	}
	private static final String SERV_ID = "crossIdAllot";
	 ...
	 */
	private CrossIdAllotServiceProxy() {}
	...
	public Object getMethodFunction(Service service, int methodKey) {
		CrossIdAllotService serv = (CrossIdAllotService)service;
		switch (methodKey) {
			case EnumCall.CrossIdAllotService_apply_int: {
	 ...
	 * @return
	 */
	public static CrossIdAllotServiceProxy newInstance() {
	 ...
	 * @return
	 */
	private static CrossIdAllotServiceProxy createInstance(String node, String port, Object id) {
		CrossIdAllotServiceProxy inst = new CrossIdAllotServiceProxy();
	...
	public void apply(int num) {
		...
		localPort.call(immutableOnce, remote, EnumCall.CrossIdAllotService_apply_int, "CrossIdAllotServiceProxy.apply", new Object[] {num});
