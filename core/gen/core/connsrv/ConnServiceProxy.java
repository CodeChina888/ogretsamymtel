...
public final class ConnServiceProxy extends ProxyBase {
	public final class EnumCall{
		public static final int ConnService_check_long = 1;
	}
	...
	public Object getMethodFunction(Service service, int methodKey) {
		...
		switch (methodKey) {
			case EnumCall.ConnService_check_long: {
	...
	public void check(long connId) {
		...
		localPort.call(immutableOnce, remote, EnumCall.ConnService_check_long, "ConnServiceProxy.check", new Object[] {connId});
