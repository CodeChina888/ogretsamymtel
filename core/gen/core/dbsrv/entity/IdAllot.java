...
public final class IdAllot extends EntityBase {
	...
	public static final class K {
		...
		public static final String MaxID = "MaxID";	//当前已分配的ID最大值
		public static final String HumanDigit = "HumanDigit";	//当前已分配的玩家标识最大值
	}
	 ...
	 * 当前已分配的玩家标识最大值
	 */
	public long getHumanDigit() {
		return record.get("HumanDigit");
	}

	public void setHumanDigit(final long HumanDigit) {
		//更新前的数据状态
		int statusOld = record.getStatus();
